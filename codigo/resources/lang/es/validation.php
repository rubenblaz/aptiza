...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex' => 'La contraseña debe tener entre 6 y 15 caracteres,letras mayusculas,minusculas
            y numeros'
        ],
        'password_repeat' => ['same' => 'Las contraseñas no coinciden'],
        'roles_selec'=>['required'=>'El usuario debe disponer de algun privilegio'],
        'password_anterior'=>['required'=>'Debes de introducir la contraseña anterior'],
        'passwordEditRepeat' => ['same' => 'Las contraseñas no coinciden'],
    ],
